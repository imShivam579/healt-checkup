!(function (NioApp) {
  ...
  (NioApp.Dropdown = {
    ...
    toggle: function (e, t) {
      ...
      a.classList.contains(t)
        ? (a.classList.remove(t), NioApp.SlideUp(s, o))
        : (a.classList.add(t), NioApp.SlideDown(s, o));
    },
    extended: function (elm, active) {
      let parent = elm.parentElement,
        nextelm = elm.nextElementSibling,
      ...
      NioApp.Win.width > eval("NioApp.Break." + navbarCollapse) &&
        elm.addEventListener("mouseenter", (e) => {
          let t =
            NioApp.getParents(elm, "." + nav.classes.main, nav.classes.sub)
              .length > 0
              ? "right-start"
              : "bottom-start";
    ...
    (NioApp.Dropdown.sidebar = function (e) {
      ...
      let a = menu.classes.active,
        s = menu.classes.subparent,
        o = menu.classes.sub;
      t.forEach((e) => {
        NioApp.Dropdown.load(e, s),
          e.addEventListener("click", function (t) {
            t.preventDefault(),
              NioApp.Dropdown.toggle(e, a),
              NioApp.Dropdown.closeSiblings(e, a, s, o);
          });
      });
    }),
  ...
  let sidebar = {
    ...
    break: {
      main: NioApp.body.dataset.sidebarCollapse
        ? eval("NioApp.Break." + NioApp.body.dataset.sidebarCollapse)
        : NioApp.Break.lg,
    },
  };
  (NioApp.Sidebar = {
    show: function (e, t) {
      e.forEach((e) => {
        ...
        t.classList.add(sidebar.classes.active),
    ...
    hide: function (e, t) {
      e.forEach((e) => {
        ...
        t.classList.remove(sidebar.classes.active),
    ...
    compact: function (e, t) {
      e.classList.toggle(sidebar.classes.compactToggleActive),
        t.classList.toggle(sidebar.classes.compact),
    ...
    (NioApp.Sidebar.init = function () {
      ...
      t.forEach((a) => {
        a.addEventListener("click", function (a) {
          a.preventDefault(),
            sidebar.break.main > NioApp.Win.width &&
              (e.classList.contains(sidebar.classes.active)
                ? NioApp.Sidebar.hide(t, e)
                : NioApp.Sidebar.show(t, e));
        }),
          window.addEventListener("resize", function (a) {
            sidebar.break.main < NioApp.Win.width && NioApp.Sidebar.hide(t, e);
          }),
          document.addEventListener("mouseup", function (a) {
            null === a.target.closest("." + sidebar.classes.base) &&
              NioApp.Sidebar.hide(t, e);
          });
      }),
        a &&
  ...
  (NioApp.Navbar = {
    ...
    (NioApp.Navbar.init = function () {
      ...
      t.forEach((a) => {
        NioApp.Navbar.mobile(e),
          ...
          document.addEventListener("mouseup", function (a) {
            null === a.target.closest("." + navbar.classes.base) &&
              NioApp.Navbar.hide(t, e);
          });
      });
    }),
      ...
      a.length > 0 &&
        a.forEach((e) => {
          let t = !!e.dataset.search && JSON.parse(e.dataset.search),
            a = !!e.dataset.sort && JSON.parse(e.dataset.sort),
            s = !e.dataset.cross || JSON.parse(e.dataset.cross);
          new Choices(e, {
            silent: !0,
            allowHTML: !1,
            searchEnabled: t,
      ...
      t.length > 0 &&
        t.forEach((e) => {
          let t = !e.dataset.cross || JSON.parse(e.dataset.cross),
            a =
              e.classList.contains("form-control-plaintext") &&
      ...
      a.length > 0 &&
        a.forEach((e) => {
          let a = !e.dataset.autoHide || JSON.parse(e.dataset.autoHide),
            ...
            l = e.dataset.startView ? parseInt(e.dataset.startView) : 0,
            r = e.dataset.title ? e.dataset.title : "",
            c = !!e.dataset.todayBtn && JSON.parse(e.dataset.todayBtn),
            p = e.dataset.todayBtnMode ? parseInt(e.dataset.todayBtnMode) : 0,
            d = e.dataset.weekStart ? parseInt(e.dataset.weekStart) : 0,
            u = !!e.dataset.range,
            m = t || {
    ...
    (NioApp.Pureknob = function (e) {
      document.querySelectorAll(e).forEach((e) => {
        let t = e.dataset.size ? parseInt(e.dataset.size) : 100,
          a = e.dataset.angleStart ? e.dataset.angleStart : 1,
          s = e.dataset.angleEnd ? e.dataset.angleEnd : 1,
          ...
          l = e.dataset.trackWidth ? e.dataset.trackWidth : 0.2,
          r = e.dataset.min ? e.dataset.min : 0,
          c = e.dataset.max ? e.dataset.max : 100,
          p = !e.dataset.readonly || JSON.parse(e.dataset.readonly),
          d = e.dataset.value ? parseInt(e.dataset.value) : 0,
          u = e.dataset.hideValue ? 0 : 1,
          m = pureknob.createKnob(t, t);
        m.setProperty("angleStart", -a * Math.PI),
          m.setProperty("angleEnd", s * Math.PI),
          m.setProperty("angleOffset", o * Math.PI),
          m.setProperty("colorFG", n),
          m.setProperty("colorBG", i),
          m.setProperty("trackWidth", l),
          m.setProperty("valMin", r),
          m.setProperty("valMax", c),
          m.setProperty("readonly", p),
          m.setProperty("textScale", u),
          m.setValue(d);
        let g = m.node();
        e.appendChild(g);
      });
    ...
    (NioApp.Dropzone = function (e) {
      ...
      "undefined" != t &&
        ...
        t.forEach((e) => {
          let t = e.id,
            a = e.dataset.maxFiles ? parseInt(e.dataset.maxFiles) : null,
            s = e.dataset.maxFilesize ? parseInt(e.dataset.maxFilesize) : 256,
            o = e.dataset.messageIcon
              ? e.dataset.messageIcon
              : 1 === a
              ? "file"
              : "files",
          ...
          e.dataset.maxFilesize &&
            n.insertAdjacentHTML("beforeend", `<small>Max ${s} MiB</small>`);
          let l = e.querySelector(".dz-message-icon:empty"),
            r = `<em class="icon icon-lg ni ni-${o}"></em>`;
          l && (l.innerHTML = r);
          new Dropzone("#" + t, {
            url: "image",
            maxFilesize: s,
      ...
      "undefined" != a &&
        ...
        a.forEach((e) => {
          ...
          (s = /\s/g.test(s) ? s.split(" ") : s),
            (s = void 0 === s ? "lower" : s),
            (s = "true" == s || "false" == s ? JSON.parse(s) : s);
          let o = e.dataset.min ? parseInt(e.dataset.min) : 0,
            i = e.dataset.max ? parseInt(e.dataset.max) : 100,
      ...
      t.length > 0 &&
        t.forEach((e) => {
          e.addEventListener("click", function (t) {
            ...
            "password" == a.type
              ? ((a.type = "text"), e.classList.add("is-shown"))
              : ((a.type = "password"), e.classList.remove("is-shown"));
          });
        });
    }),
    ...
    (NioApp.Custom.init = function () {
      NioApp.Custom.progress(),
        ...
        NioApp.CurrentLink(
          ...
          menu.classes.sub,
          menu.classes.main,
          [menu.classes.active, menu.classes.current],
          !0
        ),
